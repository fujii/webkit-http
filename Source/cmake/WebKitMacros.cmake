...
#   IDL_INCLUDES is value of --include argument. (eg. --include=${WEBCORE_DIR}/bindings/js)
#   FEATURES is a value of --defines argument.
#   DESTINATION is a value of --outputDir argument.
#   PREFIX is a prefix of output files. (eg. JS - it makes JSXXX.cpp JSXXX.h from XXX.idl)
...
function(GENERATE_BINDINGS)
    ...
    foreach (_file ${arg_INPUT_FILES})
        ...
        add_custom_command(
            OUTPUT ${arg_DESTINATION}/${arg_PREFIX}${_name}.${arg_EXTENSION} ${arg_DESTINATION}/${arg_PREFIX}${_name}.h
            ...
            VERBATIM)
        list(APPEND output_source ${arg_DESTINATION}/${arg_PREFIX}${_name}.${arg_EXTENSION})
    endforeach ()
    set(${arg_OUTPUT_SOURCE} ${${arg_OUTPUT_SOURCE}} ${output_source} PARENT_SCOPE)
endfunction()
